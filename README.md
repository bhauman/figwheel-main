...
```
clj -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.19\"}}}"  -M -m figwheel.main
```
...
```
clojure -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.19\"} com.bhauman/rebel-readline-cljs {:mvn/version \"0.1.4\"}}}}"  -M -m figwheel.main
```
...
```clojure
{:deps {com.bhauman/figwheel-main {:mvn/version "0.2.19"}
...
```clojure
:dependencies [[com.bhauman/figwheel-main "0.2.19"]
