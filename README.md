...
```
clj -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.14\"}}}"  -m figwheel.main
```
...
```
clojure -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.14\"} com.bhauman/rebel-readline-cljs {:mvn/version \"0.1.4\"}}}}"  -m figwheel.main
```
...
```clojure
{:deps {com.bhauman/figwheel-main {:mvn/version "0.2.14"}
