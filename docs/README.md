...
```
clj -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.0\"}}}}"  -m figwheel.main
```
...
```
clojure -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.2.0\"} com.bhauman/rebel-readline-cljs {:mvn/version \"0.1.4\"}}}}"  -m figwheel.main
```
