...
```
clj -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.1.8\"}}}}"  -m figwheel.main
```
...
```
clojure -Sdeps "{:deps {com.bhauman/figwheel-main {:mvn/version \"0.1.8\"} com.bhauman/rebel-readline-cljs {:mvn/version \"0.1.4\"}}}}"  -m figwheel.main
```
...
```clojure
{:deps {com.bhauman/figwheel-main {:mvn/version "0.1.8"}
...
```clojure
:dependencies [[com.bhauman/figwheel-main "0.1.8"]
